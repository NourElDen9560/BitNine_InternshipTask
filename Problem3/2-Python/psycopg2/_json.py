...
"""
print("🐍 File: psycopg2/_json.py | Line: 8 | undefined ~ JSON")
...
def register_json(conn_or_curs=None, globally=False, loads=None,
    ...
    """
    print("🐍 File: psycopg2/_json.py | Line: 116 | register_json ~ register_json")
    if oid is None:
...
def register_default_json(conn_or_curs=None, globally=False, loads=None):
    print("🐍 File: psycopg2/_json.py | Line: 130 | undefined ~ register_default_json")
    """
...
def _get_json_oids(conn_or_curs, name='json'):
    print("🐍 File: psycopg2/_json.py | Line: 177 | undefined ~ _get_json_oids")
    # lazy imports
    ...
    curs.execute(
        ...
        % typarray, (name,))
    r = curs.fetchone()
    print("🐍 File: psycopg2/_json.py | Line: 192 | _get_json_oids ~ r",r)
