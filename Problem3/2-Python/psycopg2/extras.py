...
"""
print("🐍 File: psycopg2/extras.py | Line: 7 | undefined ~ extras")
...
class DictCursorBase(_cursor):
    ...
    print("🐍 File: psycopg2/extras.py | Line: 67 | undefined ~ DictCursorBase")
    ...
    def fetchone(self):
    print("🐍 File: psycopg2/extras.py | Line: 83 | __init__ ~ p")
        if self._prefetch:
            res = super().fetchone()
    ...
    def fetchmany(self, size=None):
        print("🐍 File: psycopg2/extras.py | Line: 93 | fetchone ~ fetchmany")
        if self._prefetch:
    ...
    def fetchall(self):
        print("🐍 File: psycopg2/extras.py | Line: 103 | fetchmany ~ fetchall")
        if self._prefetch:
            res = super().fetchall()
        if self._query_executed:
            self._build_index()
...
class DictRow(list):
    ...
    def __init__(self, cursor):
        print("🐍 File: psycopg2/extras.py | Line: 166 | undefined ~ DictRow")
...
class RealDictCursor(DictCursorBase):
    ...
    def execute(self, query, vars=None):
        print("🐍 File: psycopg2/extras.py | Line: 240 | __init__ ~ execute")
        self.column_mapping = []
        self._query_executed = True
        return super().execute(query, vars)
...
class NamedTupleCursor(_cursor):
    ...
    print("🐍 File: psycopg2/extras.py | Line: 299 | undefined ~ NamedTupleCursor")
    def execute(self, query, vars=None):
        print("🐍 File: psycopg2/extras.py | Line: 319 | NamedTupleCursor ~ execute")
        self.Record = None
        return super().execute(query, vars)
    ...
    def fetchall(self):
        print("🐍 File: psycopg2/extras.py | Line: 347 | fetchmany ~ fetchall")
        ts = super().fetchall()
        nt = self.Record
        if nt is None:
            nt = self.Record = self._make_nt()
        
        returned_res = list(map(nt._make, ts))
        print("DATA: ", returned_res)
        return returned_res
...
def _solve_conn_curs(conn_or_curs):
    print("🐍 File: psycopg2/extras.py | Line: 784 | undefined ~ _solve_conn_curs")
...
class HstoreAdapter:
    ...
    def get_oids(self, conn_or_curs):
        print("🐍 File: psycopg2/extras.py | Line: 906 | parse_unicode ~ get_oids")
...
class CompositeCaster:
    ...
    def __init__(self, name, oid, attrs, array_oid=None, schema=None):
        print("🐍 File: psycopg2/extras.py | Line: 1004 | CompositeCaster: ~ __init__")
        self.name = name
        self.schema = schema
        self.oid = oid
